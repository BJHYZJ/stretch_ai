...
from yanzj.app.lfd.policy_utils import load_policy, prepare_action_dict, prepare_observations
...
class StretchBodyLfdLeader(Evaluator):
    """Stretch body version of leader for evaluating trained LfD policies with yanzj. To be used in conjunction with yanzj.app.dex_teleop.follower"""
    ...
    def apply(self, message, display_received_images: bool = True) -> dict:
        ...
        # Send action_dict to yanzj follower
        self.goal_send_socket.send_pyobj(action_dict)
