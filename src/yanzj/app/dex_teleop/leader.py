...
import yanzj.app.dex_teleop.dex_teleop_parameters as dt
import yanzj.app.dex_teleop.dex_teleop_utils as dt_utils
import yanzj.app.dex_teleop.goal_from_teleop as gt
import yanzj.app.dex_teleop.webcam_teleop_interface as wt
import yanzj.motion.simple_ik as si
import yanzj.utils.compression as compression
import yanzj.utils.logger as logger
from yanzj.core import Evaluator
from yanzj.core.client import RobotClient
from yanzj.motion.pinocchio_ik_solver import PinocchioIKSolver
from yanzj.utils.data_tools.record import FileDataRecorder
    ...
    def get_goal_joint_config(
        ...
        **config,
        ...
        if new_goal_configuration is None:
            ...
            # TODO
            # Following line used by simple_IK, but can only be run on yanzj due to need for robot status.
