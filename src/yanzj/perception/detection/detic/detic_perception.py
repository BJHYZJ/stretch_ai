...
from yanzj.core.abstract_perception import PerceptionModule
from yanzj.perception.detection.utils import filter_depth, overlay_masks
...
from yanzj.perception.detection.detic.Detic.detic.config import add_detic_config  # noqa: E402
from yanzj.perception.detection.detic.Detic.detic.modeling.text.text_encoder import (  # noqa: E402
    build_text_encoder,
)
from yanzj.perception.detection.detic.Detic.detic.modeling.utils import (  # noqa: E402
    reset_cls_test,
)
...
class DeticPerception(PerceptionModule):
    def __init__(
        ...
        cfg = setup_cfg(args, verbose=verbose, confidence_threshold=confidence_threshold)
