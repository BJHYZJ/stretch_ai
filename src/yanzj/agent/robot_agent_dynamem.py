...
from yanzj.agent.manipulation.dynamem_manipulation.dynamem_manipulation import (
    DynamemManipulationWrapper as ManipulationWrapper,
)
from yanzj.agent.manipulation.dynamem_manipulation.grasper_utils import (
    capture_and_process_image,
    move_to_point,
    pickup,
    process_image_for_placing,
)
from yanzj.agent.robot_agent import RobotAgent as RobotAgentBase
...
from yanzj.core.robot import AbstractGraspClient, AbstractRobotClient
from yanzj.mapping.instance import Instance
from yanzj.mapping.voxel import SparseVoxelMapDynamem as SparseVoxelMap
from yanzj.mapping.voxel import (
    SparseVoxelMapNavigationSpaceDynamem as SparseVoxelMapNavigationSpace,
)
from yanzj.mapping.voxel import SparseVoxelMapProxy
from yanzj.motion.algo.a_star import AStar
from yanzj.perception.detection.owl import OwlPerception
from yanzj.perception.encoders import MaskSiglipEncoder
    ...
    def place(
        ...
        if not local:
            ...
            if self.owl_sam_detector is None:
                from yanzj.perception.detection.owl import OWLSAMProcessor
