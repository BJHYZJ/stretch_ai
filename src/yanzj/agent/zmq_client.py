...
from yanzj.utils.memory import lookup_address
...
class HomeRobotZmqClient(AbstractRobotClient):
    ...
    def _create_recv_socket(
        ...
        if ip_address is None:
            ...
            logger.error("    yanzj.app.<this app> --robot_ip <robot_ip>")
    ...
    def __init__(
        ...
        if enable_rerun_server:
            from yanzj.visualization.rerun import RerunVisualizer
