...
from yanzj.core.parameters import Parameters
from yanzj.mapping.grid import GridParams
from yanzj.mapping.instance import Instance, InstanceMemory
from yanzj.motion import Footprint, HelloStretchIdx, PlanResult, RobotModel
from yanzj.perception.encoders import BaseImageTextEncoder
from yanzj.perception.wrapper import OvmmPerception
from yanzj.utils.data_tools.dict import update
from yanzj.utils.logger import Logger
from yanzj.utils.morphology import binary_dilation, binary_erosion, get_edges
from yanzj.utils.point_cloud import create_visualization_geometries, numpy_to_pcd, points_in_mesh
from yanzj.utils.point_cloud_torch import unproject_masked_depth_to_xyz_coordinates
from yanzj.utils.visualization import create_disk
from yanzj.utils.voxel import VoxelizedPointcloud, scatter3d
from yanzj.visualization.urdf_visualizer import URDFVisualizer
...
class SparseVoxelMap(object):
    ...
    def write_to_pickle(self, filename: str, compress: bool = True) -> None:
        ...
        logger.alert()
        logger.alert(f"\tpython -m yanzj.app.read_map -i {filename} --show-svm")
        logger.alert()
