...
try:
    from yanzj.simulation.robocasa_gen import load_model_from_xml, model_generation_wizard
except ImportError as e:
    from yanzj.utils.logger import error
...
import yanzj.simulation.utils as sim_utils
...
from yanzj.motion import HelloStretchIdx
from yanzj.motion.control.goto_controller import GotoVelocityController
from yanzj.utils.config import get_control_config
from yanzj.utils.geometry import pose_global_to_base, xyt_base_to_global, xyt_global_to_base
from yanzj.utils.image import scale_camera_matrix
...
class MujocoZmqServer(BaseZmqServer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # They should probably stay in yanzj mujoco
...
@click.option(
    "--scene_path", default=None, help="Provide a path to mujoco scene file with yanzj.xml"
)
@click.option(
    "--use-robocasa",
    "--use_robocasa",
