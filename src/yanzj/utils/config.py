...
CONFIG_ROOT = str(Path(yanzj.__path__[0]).resolve() / "config")
CONTROL_CONFIG_DIR = str(Path(yanzj.__path__[0]).resolve() / "config" / "control")

DATA_ROOT = str(Path(yanzj.__path__[0]).parent.resolve() / "../data")
