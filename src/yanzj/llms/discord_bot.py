...
from yanzj.agent.task.dynamem import DynamemTaskExecutor
from yanzj.agent.task.pickup import PickupExecutor
from yanzj.llms import PickupPromptBuilder, get_llm_client
from yanzj.utils.discord_bot import DiscordBot, Task
...
class StretchDiscordBot(DiscordBot):
    """Simple yanzj discord bot. Connects to Discord via the API."""
    ...
    def __init__(
        ...
        home_channel: str = "talk-to-yanzj",
    ) -> None:
        """
