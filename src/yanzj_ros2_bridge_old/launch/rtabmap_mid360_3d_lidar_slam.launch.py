# Description:
#   Pure 3D LiDAR SLAM using MID-360 LiDAR sensor
#   Based on rtabmap examples with ICP odometry and mapping
#
# Example:
#   Launch your MID-360 lidar sensor first:
#   $ ros2 launch yanzj_ros2_bridge livox_mid360_driver.launch.py
#
#   Then launch this SLAM system:
#   $ ros2 launch yanzj_ros2_bridge mid360_3d_lidar_slam.launch.py
...
def launch_setup(context: LaunchContext, *args, **kwargs):
  ...
  # Rule of thumb for MID-360 (indoor/outdoor hybrid use)
  ...
  rtabmap_parameters = {
    ...
    'RGBD/CreateOccupancyGrid': 'true',  # Enable occupancy grid for navigation
...
def generate_launch_description():
  return LaunchDescription([
    ...
    DeclareLaunchArgument(
      ...
      description='Base frame of the robot (should match your TF configuration).'),
    ...
    DeclareLaunchArgument(
      ...
      description='Name of the MID-360 lidar PointCloud2 topic.'),

    DeclareLaunchArgument(
      'imu_topic', default_value='/livox/imu',
      description='IMU topic from MID-360.'),
    
    DeclareLaunchArgument(
      'expected_update_rate', default_value='10.0',
      description='Expected lidar frame rate. MID-360 typically runs at 10 Hz.'),
    
    DeclareLaunchArgument(
      'voxel_size', default_value='0.1',
      description='Voxel size (m) of the downsampled lidar point cloud. For indoor, set it between 0.1 and 0.3.'),
    ...
    DeclareLaunchArgument(
      ...
      description='Use fast slerp interpolation between first and last stamps of the scan for deskewing.'),
