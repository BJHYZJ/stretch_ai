...
def generate_launch_description():
    yanzj_path = get_package_share_directory('yanzj_ros2_bridge')
    ...
    rviz_config = DeclareLaunchArgument('rviz_config',
                                        default_value=yanzj_path + '/' + 'rviz/rtabmap.rviz')
    ...
    d435i_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([yanzj_path, '/launch/d435i_high_resolution.launch.py']))
