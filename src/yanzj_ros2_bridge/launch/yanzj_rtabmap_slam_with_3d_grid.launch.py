...
def launch_setup(context: LaunchContext, *args, **kwargs):
  ...
  rtabmap_parameters = {
    ...
    'Grid/MaxGroundHeight': '0.1',        # 最大地面高度 (米) - 允许一定坡度
    'Grid/MinGroundHeight': '-0.1',       # 最小地面高度 (米) - 允许下坡
    
    'Grid/MaxObstacleHeight': '3',      # 最大障碍物高度 (米) - 适合小车通过
    'Grid/GroundIsObstacle': 'false',     # 地面不视为障碍物

    'Grid/PreVoxelFiltering': 'true',     # 预处理体素滤波
    'Grid/NoiseFilteringRadius': '0.05',   # 噪声过滤半径
    'Grid/NoiseFilteringMinNeighbors': '3', # 最小邻居数量
...
def generate_launch_description():
  return LaunchDescription([
    ...
    DeclareLaunchArgument(
      'fast_lio_cloud_topic', default_value='/fast_lio2/cloud_registered',  # /fast_lio2/cloud_registered在odom坐标系下
