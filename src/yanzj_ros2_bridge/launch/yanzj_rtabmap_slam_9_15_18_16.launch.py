...
def launch_setup(context: LaunchContext, *args, **kwargs):
  ...
  fast_lio_cloud_topic = LaunchConfiguration('fast_lio_cloud_topic').perform(context)
      ...
      actions=[
        Node(
          ...
          parameters=[shared_parameters, rtabmap_parameters, 
                      {'rgbd_cameras': 1}],
          remappings=remappings + [('scan_cloud', fast_lio_cloud_topic)],
          arguments=arguments),
