...
def launch_setup(context: LaunchContext, *args, **kwargs):
  ...
  rtabmap_parameters = {
    ...
    'RGBD/ForceOdom3DoF': 'true',       # 默认: true - Force odometry pose to be 3DoF if Reg/Force3DoF=true.
    ...
    'Grid/NoiseFilteringRadius': '0.15',  # 邻域半径（米） 0.1~0.25
    'Grid/NoiseFilteringMinNeighbors': '2',     # 至少 N 个邻居才保留（2~3）

    # 'Grid/MaxObstacleHeight': '2.5',
    'Grid/GroundIsObstacle': 'false',
    'Grid/RangeMax': '0.0',  # Maximum range from sensor. 0=inf.
    'Grid/RangeMin': '0.0',
...
def generate_launch_description():
  return LaunchDescription([
    ...
    DeclareLaunchArgument(
      'fast_lio_cloud_topic', default_value='/fast_lio2/cloud_registered_body',  # /fast_lio2/cloud_registered在odom坐标系下
