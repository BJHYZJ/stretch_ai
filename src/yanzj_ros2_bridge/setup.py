...
package_name = "yanzj_ros2_bridge"
...
setup(
    ...
    entry_points={
        "console_scripts": [
            "camera_pose_publisher = yanzj_ros2_bridge.nodes.camera_pose_publisher:main",
            "rotate_images = scripts.rotate_images",
            "state_estimator = yanzj_ros2_bridge.nodes.state_estimator:main",
